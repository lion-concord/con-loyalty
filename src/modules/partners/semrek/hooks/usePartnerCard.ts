...
const STORAGE_KEY = "kon-partner-cards-v2";
...
export function usePartnerCard(partnerId: string) {
  ...
  const earnCashback = (orderTotal: number, orderId: string) => {
    ...
    const updatedCard = { ...card, cashbackBalance: card.cashbackBalance + amount, history: [transaction, ...card.history] };
