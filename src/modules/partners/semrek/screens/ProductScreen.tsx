...
export default function ProductScreen({ productId, onBack }: Props) {
    ...
    <div>
      ...
      <div className="sr-container">
        ...
        <div style={{
          ...
          {product.category === "boat" ? "🚤" : product.category === "motor" ? "⚙️" : "🎒"}
        </div>
        ...
        <button className="sr-btn sr-btn--primary" onClick={() => alert("Заказ оформляется через менеджера по телефону +7 (904) 892-84-57")}>
          Заказать
        </button>
