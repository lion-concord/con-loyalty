...
export const products: Product[] = [
  {
    id: "gt-320",
    category: "boat",
    name: "Sibriver GT-320",
    description: "Компактная моторная лодка для рыбалки и охоты. Прочный корпус из ПВХ 850 г/м², водомётный транец, фальшборт.",
    price: 84500,
    image: "/partners/semrek/boats/gt-320.jpg",
    specs: { Длина: "3,2 м", Ширина: "1,55 м", "Макс. мощность": "15 л.с.", "Грузоподъёмность": "450 кг", Пассажиры: "2+1" },
    inStock: true,
  },
  {
    id: "gt-360",
    category: "boat",
    name: "Sibriver GT-360",
    description: "Универсальная лодка для семейного отдыха и рыбалки. Устойчивая, просторная, надувной киль НДНД.",
    price: 112000,
    image: "/partners/semrek/boats/gt-360.jpg",
    specs: { Длина: "3,6 м", Ширина: "1,65 м", "Макс. мощность": "20 л.с.", "Грузоподъёмность": "600 кг", Пассажиры: "3+1" },
    inStock: true,
  },
  {
    id: "gt-420",
    category: "boat",
    name: "Sibriver GT-420",
    description: "Флагман серии GT. Максимальная прочность, эргономика, просторный кокпит. Для водомётного хода.",
    price: 149000,
    image: "/partners/semrek/boats/gt-420.jpg",
    specs: { Длина: "4,2 м", Ширина: "1,85 м", "Макс. мощность": "40 л.с.", "Грузоподъёмность": "800 кг", Пассажиры: "4+1" },
    inStock: true,
  },
  {
    id: "gt-480",
    category: "boat",
    name: "Sibriver GT-480",
    description: "Экспедиционная лодка для дальних рейдов. Усиленный корпус, большой запас топлива, высокий фальшборт.",
    price: 165950,
    image: "/partners/semrek/boats/gt-480.jpg",
    specs: { Длина: "4,8 м", Ширина: "2,0 м", "Макс. мощность": "60 л.с.", "Грузоподъёмность": "1000 кг", Пассажиры: "5+1" },
    inStock: true,
  },
  {
    id: "gt-520",
    category: "boat",
    name: "Sibriver GT-520",
    description: "Максимальная модель линейки GT. Для профессиональной рыбалки и сложных условий Енисея.",
    price: 199900,
    image: "/partners/semrek/boats/gt-520.jpg",
    specs: { Длина: "5,2 м", Ширина: "2,1 м", "Макс. мощность": "80 л.с.", "Грузоподъёмность": "1200 кг", Пассажиры: "6+1" },
    inStock: false,
  },
  {
    id: "solar-420-jet",
...
id: "solar-430-sjt",
    category: "boat",
    name: "SOLAR 430 Super Jet Tunnel",
    description: "Надувная моторная лодка с водомётным тоннелем. Грузоподъёмность 700 кг, длина 4.3 м, ширина 1.75 м, диаметр баллона 0.45 м. Вес 75 кг.",
    price: 167100,
    image: "/partners/semrek/boats/solar-430-sjt.jpg",
