        ...
        <div className="login-logo">
          ...
          <div className="logo-stats">
            <span className="stat-item">
              ...
              <span className="stat-text">10 000+ участников</span>
            </span>
          </div>
        </div>
        ...
        <div className="login-content">
          ...
          <div className="login-features">
            <div className="feature-item">
              ...
              <div className="feature-text">Бонусы за покупки</div>
            </div>
            <div className="feature-item">
              <div className="feature-icon">💎</div>
              <div className="feature-text">Эксклюзивные акции</div>
            </div>
            <div className="feature-item">
              <div className="feature-icon">🏆</div>
              <div className="feature-text">Статусы и привилегии</div>
            </div>
          </div>
