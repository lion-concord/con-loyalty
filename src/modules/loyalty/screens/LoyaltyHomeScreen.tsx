...
function Card({
  ...
  return <section className={`lk-card lk-card--glass ${className}`.trim()}>{children}</section>;
}
...
export default function LoyaltyHomeScreen({
  ...
  return (
    <div className="lk-screen lk-screen--premium">
      ...
      <Card className="lk-club-card lk-club-card--compact">
        <div className="lk-club-head">
          <div className="lk-club-current">
            <span className="lk-status-icon">{currentStatus.icon}</span>
<span className="lk-status-name">{currentStatus.title}</span>
          </div>
          <div className="lk-club-balance">{konBalance.toLocaleString("ru-RU")} КОН</div>
        </div>
      ...
      <Card className="lk-actions-card">
        <div className="lk-section-title">Действия</div>
        <div className="lk-actions">
          <button type="button" className="lk-button lk-button--secondary" onClick={onOpenProfile}>
            Профиль
          </button>
          <button type="button" className="lk-button lk-button--secondary" onClick={onOpenQr}>
            QR-карта
          </button>
          <button type="button" className="lk-button lk-button--secondary" onClick={onOpenHistory}>
            История
          </button>
          <button type="button" className="lk-button lk-button--secondary" onClick={handleLogout}>
            Выйти
          </button>
        </div>
      </Card>
      ...
      <Card className="lk-partner-card">
        ...
        <div className="lk-section-subtitle">Каталог лодок, моторов и аксессуаров.</div>
        <button type="button" className="lk-button lk-button--primary" onClick={onOpenSemrek}>
          Открыть «Семь рек»
        </button>
      </Card>
    </div>
