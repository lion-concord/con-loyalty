  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(180deg, #0a1929 0%, #0d1f33 100%)", color: "#fff", padding: 20 }}>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
        ...
        <button onClick={() => { setMode("file"); }} style={{ flex: 1, padding: "10px", borderRadius: 12, border: "none", background: mode === "file" ? "#3b82f6" : "rgba(255,255,255,0.08)", color: "#fff", cursor: "pointer" }}>Фото</button>
        <button onClick={() => { setMode("manual"); }} style={{ flex: 1, padding: "10px", borderRadius: 12, border: "none", background: mode === "manual" ? "#3b82f6" : "rgba(255,255,255,0.08)", color: "#fff", cursor: "pointer" }}>Вручную</button>
      </div>
